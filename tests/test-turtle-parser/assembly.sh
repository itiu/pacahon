...
~/dmd2/linux/bin/dmd -version=D2 -debug -g $mdir/test-turtle-parser.d $pr_dir/src/utils.d $pr_dir/src/graph.d $pr_dir/src/turtle-parser.d -oftest-turtle-parser-D2
