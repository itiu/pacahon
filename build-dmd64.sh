...
m_static="lib64/libanl.a lib64/liblmdb.a lib64/libxapiand.a lib64/libxapian-main.a lib64/libxapian-backend.a lib64/libzmq.a lib64/libstdc++.a lib64/libuuid.a lib64/librabbitmq.a"
m_shared="-L-lzmq -L-lxapiand -L-lxapian --L-llmdb -L-lrabbitmq"

$DMD -m64 -O -g -release -inline -version=executable @pacahon-src-list $m_static -oftarget/Pacahon-$VERSION_MAJOR-$VERSION_MINOR-$VERSION_PATCH-64-sl
$DMD -m64 -O -g -release -inline -version=executable @pacahon-src-list $m_shared -oftarget/Pacahon-$VERSION_MAJOR-$VERSION_MINOR-$VERSION_PATCH-64
